...
// func (h *OwnersHandler) UpdateOwners(w http.ResponseWriter, r *http.Request) {
// 	log.Println("UpdateOwners")
// 	ownerID := mux.Vars(r)["ownerID"]
// 	owner := &owner{}
// 	err := json.NewDecoder(r.Body).Decode(owner)
// 	if err != nil {
...
// func (h *OwnersHandler) DeleteOwners(w http.ResponseWriter, r *http.Request) {
// 	log.Println("DeleteOwners")
// 	ownerID := mux.Vars(r)["ownerID"]
